...
server.registerTool("drift_verify", {
    title: "Drift Verify",
    description: "Report an intent's recorded verification command and signature state WITHOUT executing it (default). Set run:true to execute, which is allowed only when the manifest is validly signed by the repository key — repository-provided verification strings are code.",
    inputSchema: {
        intentId: z.string(),
